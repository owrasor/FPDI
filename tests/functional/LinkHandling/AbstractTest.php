...
use owrasor\Fpdi\functional\PdfTypeDumper;
...
//        file_put_contents(__DIR__ . '/test.pdf', $pdfString);
        ...
        $expectedLinks = [
            [
                'uri' => 'https://demos.owrasor.com/?ArtBox',
                'rect' => [2.67, 144.4, 42.7, 159.83],
            ],
            [
                'uri' => 'https://demos.owrasor.com/?TrimBox',
                'rect' => [-24.01, 117.73, 25.64, 133.15],
            ],
            [
                'uri' => 'https://demos.owrasor.com/?BleedBox',
                'rect' => [-50.69, 91.05, 6.4, 106.47],
            ],
            [
                'uri' => 'https://demos.owrasor.com/?CropBox',
